...
const createStudent = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserService.createStudentToDB(
      student,
      userData
    );
...
const createFaculty = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserService.createFacultyToDB(
      faculty,
      userData
    );
    (0, sendResponse_1.default)(res, {
...
const createAdmin = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserService.createAdminToDB(
      admin,
      userData
    );
    (0, sendResponse_1.default)(res, {
