...
const findLastAdminId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lastAdmin = yield user_model_1.User.findOne({
        ...
        .lean();
    return (lastAdmin === null || lastAdmin === void 0 ? void 0 : lastAdmin.id) ? (_a = lastAdmin === null || lastAdmin === void 0 ? void 0 : lastAdmin.id) === null || _a === void 0 ? void 0 : _a.substring(2) : undefined;
});
...
const generateStudentId = (academicSemester) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fullStudentID = `${(_b = academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.year) === null || _b === void 0 ? void 0 : _b.substring(2)}${academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.code}${incrementedId}`;
