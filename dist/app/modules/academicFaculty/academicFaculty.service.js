...
const createAcademicFacultyToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicFaculty_constant_1.academicFacultyTitleMapper.includes(payload.title)) {
        const result = yield academicFaculty_model_1.AcademicFaculty.create(payload);
        return result;
    }
    else {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid Faculty!');
    }
});
const getAcademicFacultyFromDB = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const andCondition = [];
