...
const createDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.createDepartment(
        departmentData
      );
...
const getAllDepartments = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.getAllDepartments(
        filters,
        paginationOptions
      );
    (0, sendResponse_1.default)(res, {
...
const getSingleDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.getSingleDepartment(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateDepartment = (0, catchAsync_1.default)(
  (0, catchAsync_1.default)((req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { id } = req.params;
      const updatedData = req.body;
      const result =
        yield managementDepartment_service_1.ManagementDepartmentService.updateDepartment(
          id,
          updatedData
        );
      (0, sendResponse_1.default)(res, {
...
const deleteDepartment = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield managementDepartment_service_1.ManagementDepartmentService.deleteDepartment(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
