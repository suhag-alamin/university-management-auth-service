...
const createSemester = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (academicSemester_constant_1.academicSemesterTitleCodeMapper[payload === null || payload === void 0 ? void 0 : payload.title] !== (payload === null || payload === void 0 ? void 0 : payload.code)) {
...
const updateSemester = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (payload.title &&
        payload.code &&
        academicSemester_constant_1.academicSemesterTitleCodeMapper[payload === null || payload === void 0 ? void 0 : payload.title] !== (payload === null || payload === void 0 ? void 0 : payload.code)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Invalid Semester Code!');
    }
    const result = yield academicSemester_model_1.AcademicSemester.findOneAndUpdate({
        _id: id,
    }, payload, {
        new: true,
    });
